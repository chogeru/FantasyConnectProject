...
#else
	[VolumeComponentEditor(typeof(EdgeFusion))]
#endif
...
#else
				sceneTerrainsCache = UnityEngine.Object.FindObjectsByType<Terrain>(FindObjectsSortMode.None);
#endif
...
#else
			return UnityEngine.Object.FindObjectsByType<EdgeFusionObject>(FindObjectsSortMode.None).Length > 0;
#endif
		}
