...
https://assetstore.unity.com/packages/package/334484#reviews
...
Version 3.3.3
- [Fix] Overlay cameras no longer spam a repeating "camera stack" warning every frame

Version 3.3.2
- Added "Ignore Overlay Cameras" option to the render feature (default on). Disable it to run Edge Fusion on a stacked overlay camera
