Shader "Universal Render Pipeline/Lit + Cavity"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "Urp2022 LitInputCavity.hlsl"
			#include "Packages/com.unity.render-pipelines.universal/Shaders/LitForwardPass.hlsl"

            void LitPassFragmentCavity(
                Varyings input
	    ...
	    //with LitInputCavity instead of LitInput for batching, and our CustomEditor .cs
        Pass
        {
            Name "ShadowCaster"
            Tags
	...
	CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.LitShaderCavity2022"
}
